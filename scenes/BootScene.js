...
BootScene.create = function() {
	...
	var logo = this.add.image(centerX, centerY, 'img_enemy2').setOrigin(0.5, 0.4);
	var startI = this.add.image(centerX, centerY, 'img_start').setOrigin(0.5, -3);
...
BootScene.ImageClicked = function() {
	...
	//play soundtrack
	soundTrack = BootScene.sound.add("snd_soundtrack");
